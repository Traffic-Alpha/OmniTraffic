...
使用随机策略收集交通场景数据。随机选择信号相位。

命令示例:
    MAP=France_Massy SCENE=easy_high_density_barrier python collector/random_collector.py
    MAP=France_Massy SCENE=easy_high_density_tree_branch python collector/random_collector.py

与其他脚本的区别:
    - rl_collector: 纯RL策略
    - fixed_timing_collector: 固定配时策略
    - random_collector: 随机策略（当前脚本）
